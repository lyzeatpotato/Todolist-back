...
public class MemorabiliaSqlProvider {

//    public String countByExample(SchoolHistoryFiguresExample example) {
//        SQL sql = new SQL();
//        sql.SELECT("count(*)").FROM("memorabilia");
...
//    }
    ...
    public String selectByExampleWithBLOBs(MemorabiliaFiguresExample example) {
        SQL sql = new SQL();
        ...
        sql.SELECT("month");
        sql.SELECT("picture");
        sql.SELECT("pic_detail");
        sql.SELECT("school");
        sql.FROM("memorabilia");
        applyWhere(sql, example, false);
...
//    }
//
    protected void applyWhere(SQL sql, MemorabiliaFiguresExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
//
