...
public class CloudBlessSqlProvider {
...
//    }
    ...
    public String selectByExampleWithBLOBs(CloudBlessExample example) {
        SQL sql = new SQL();
...
//    }
//
    protected void applyWhere(SQL sql, CloudBlessExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
//
